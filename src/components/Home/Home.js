...
function Home() {
  ...
  <div className="container-fluid">
    <h2 className="font-weight-bold text-uppercase text-center pt-4">trang trí nội thất</h2>
  ...
  <div className="container-fluid">
    <h2 className="font-weight-bold text-uppercase text-center pt-5">sản phẩm nổi bật</h2>
    <div className={cx('border-cus')}></div>
  </div>
  <div className="container p-0">
    <div className="row d-flex justify-content-between">
      <div className={cx('card','product-home')}>
        <img className={cx('card-img-top')} src="./images/gl410.jpg" alt="..." />
        <div className="card-body text-center">
          <h5 className="card-title">Ghế lưới GL140</h5>
          <Link to='/' className={cx('btn','btn-details')}>Xem chi tiết</Link>
        </div>
      </div>
      <div className={cx('card','product-home')}>
        <img className={cx('card-img-top')} src="./images/hr1800.jpg" alt="..." />
        <div className="card-body text-center">
          <h5 className="card-title">Tủ HR1800-2B</h5>
          <Link to='/' className={cx('btn','btn-details')}>Xem chi tiết</Link>
        </div>
      </div>
      <div className={cx('card','product-home')}>
        <img className={cx('card-img-top')} src="./images/ibie.jpg" alt="..." />
        <div className="card-body text-center">
          <h5 className="card-title">Bàn làm việc IBIE</h5>
          <Link to='/' className={cx('btn','btn-details')}>Xem chi tiết</Link>
        </div>
      </div>
      <div className={cx('card','product-home')}>
        <img className={cx('card-img-top')} src="./images/bk206.jpg" alt="..." />
        <div className="card-body text-center">
          <h5 className="card-title">Bàn học sinh BK206</h5>
          <Link to='/' className={cx('btn','btn-details')}>Xem chi tiết</Link>
        </div>
      </div>
    </div>
